                ...
                <div class="row">
                    ...
                    <div class="row col-sm-12 mb-3">
                        ...
                        <div class="form-check form-switch col fs-3">
                            <input type="checkbox" name="visibility" id="visibility" class="form-check-input" checked>
                        </div>
                    </div>
                    <div class="row col-sm-12 mb-3">
                        <label for="allow_ads" class="col-lg-2 col col-form-label">Allow Ads:</label>
                        <div class="form-check form-switch col fs-3">
                            <input type="checkbox" name="allow_ads" id="allow_ads" class="form-check-input">
                        </div>
                    </div>
                </div>
                <div class="text-center">
                    <button type="submit" class="btn btn-outline-dark" name="add_category">
                        ADD NEW CATEGORY
                    </button>
                </div>
            </form>
