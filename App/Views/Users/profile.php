    ...
    <aside class="col-xl-3 col-lg-4">
        <div class="sidebar-profile">
            <div class="profile-info">
                ...
                <p class="text-muted text-sm mb-0"><?php echo $_SESSION["user_name"] ?></p>
            </div>
        </div>
        <div class="menu">
            <div class="list-group" id="list-tab" role="tablist">
                ...
                <a class="list-group-item list-group-item-action" data-bs-toggle="link" href="<?php url('customer/logout') ?>">
